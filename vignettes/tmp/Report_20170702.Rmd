...
vignette: >
  %\VignetteIndexEntry{Report at 2017-07-02}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

# Results when all studies are complete

```{r simulate0, echo=FALSE, results='hide', fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library(netcopula)
...
# Results when 10 studies have one outcome MCAR

```{r simulate5, echo=FALSE, results='hide', fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library(netcopula)
...
# Results when 20 studies have one outcome MCAR

```{r simulate10, echo=FALSE, results='hide', fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library(netcopula)
...
# Results when 30 studies have one outcome MCAR

```{r simulate15, echo=FALSE, results='hide', fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
library(netcopula)
