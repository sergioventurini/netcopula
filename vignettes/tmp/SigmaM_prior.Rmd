---
title: "Prior for $\\boldsymbol{\\Sigma}_M$"
...
- \usepackage{bm}
vignette: >
  %\VignetteIndexEntry{Prior for $\\boldsymbol{\\Sigma}_M$}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

```{r global_setting, echo=TRUE, results='hide', message=FALSE}
# input parameters
...
```{r prior, echo=FALSE, results="asis"}
