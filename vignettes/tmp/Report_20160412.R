## ----prior, echo=FALSE, fig.height=8, fig.width=8, message=FALSE, warning=FALSE----
library(netcopula)
...
## ----mu_delta_1, echo=FALSE, fig.height=8.5, fig.width=8.5, message=FALSE, warning=FALSE----
...
## ---- echo=FALSE, fig.height=8.5, fig.width=8.5, message=FALSE, warning=FALSE----
par <- c(10, 10)
tau <- 0
eta <- 1
y <- 80
